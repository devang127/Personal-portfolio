...
import projImg6 from "../assets/img/spotify.jpg"
  ...
  const projects = [
    {
      ...
      description: "The application that allows users to listen to music from various artists",
      imgUrl: projImg6,
      Link: "https://spotify-clone-devangsawant.netlify.app/"
    },
    {
